...
let light_square = '#e3cfb4'
let dark_square = '#5c8b93'
...
function preload() {
  bB = loadImage('./projects/crooked-rook/piece_sets/kosal/bB.svg');
  bR = loadImage('./projects/crooked-rook/piece_sets/kosal/bR.svg');
  bK = loadImage('./projects/crooked-rook/piece_sets/kosal/bK.svg');
  bN = loadImage('./projects/crooked-rook/piece_sets/kosal/bN.svg');
  bP = loadImage('./projects/crooked-rook/piece_sets/kosal/bP.svg');
  bQ = loadImage('./projects/crooked-rook/piece_sets/kosal/bQ.svg');
  wB = loadImage('./projects/crooked-rook/piece_sets/kosal/wB.svg');
  wK = loadImage('./projects/crooked-rook/piece_sets/kosal/wK.svg');
  wN = loadImage('./projects/crooked-rook/piece_sets/kosal/wN.svg');
  wP = loadImage('./projects/crooked-rook/piece_sets/kosal/wP.svg');
  wQ = loadImage('./projects/crooked-rook/piece_sets/kosal/wQ.svg');
  wR = loadImage('./projects/crooked-rook/piece_sets/kosal/wR.svg');
  abB = loadImage('./projects/crooked-rook/piece_sets/alpha/bB.svg');
  abR = loadImage('./projects/crooked-rook/piece_sets/alpha/bR.svg');
  abK = loadImage('./projects/crooked-rook/piece_sets/alpha/bK.svg');
  abN = loadImage('./projects/crooked-rook/piece_sets/alpha/bN.svg');
  abP = loadImage('./projects/crooked-rook/piece_sets/alpha/bP.svg');
  abQ = loadImage('./projects/crooked-rook/piece_sets/alpha/bQ.svg');
  awB = loadImage('./projects/crooked-rook/piece_sets/alpha/wB.svg');
  awK = loadImage('./projects/crooked-rook/piece_sets/alpha/wK.svg');
  awN = loadImage('./projects/crooked-rook/piece_sets/alpha/wN.svg');
  awP = loadImage('./projects/crooked-rook/piece_sets/alpha/wP.svg');
  awQ = loadImage('./projects/crooked-rook/piece_sets/alpha/wQ.svg');
  awR = loadImage('./projects/crooked-rook/piece_sets/alpha/wR.svg');
  lbB = loadImage('./projects/crooked-rook/piece_sets/letter/bB.svg');
  lbR = loadImage('./projects/crooked-rook/piece_sets/letter/bR.svg');
  lbK = loadImage('./projects/crooked-rook/piece_sets/letter/bK.svg');
  lbN = loadImage('./projects/crooked-rook/piece_sets/letter/bN.svg');
  lbP = loadImage('./projects/crooked-rook/piece_sets/letter/bP.svg');
  lbQ = loadImage('./projects/crooked-rook/piece_sets/letter/bQ.svg');
  lwB = loadImage('./projects/crooked-rook/piece_sets/letter/wB.svg');
  lwK = loadImage('./projects/crooked-rook/piece_sets/letter/wK.svg');
  lwN = loadImage('./projects/crooked-rook/piece_sets/letter/wN.svg');
  lwP = loadImage('./projects/crooked-rook/piece_sets/letter/wP.svg');
  lwQ = loadImage('./projects/crooked-rook/piece_sets/letter/wQ.svg');
  lwR = loadImage('./projects/crooked-rook/piece_sets/letter/wR.svg');
...
function setup() {
  ...
  document.getElementById("diff-one").style.backgroundColor = '#b1a58d';
  document.getElementById("diff-two").style.backgroundColor = '#b1a58d';
  document.getElementById("diff-three").style.backgroundColor = '#b1a58d';
  document.getElementById("diff-four").style.backgroundColor = '#b1a58d';
...
function mini_max_root(depth, alpha, beta) {
  ...
  const moves_calculated = document.getElementById("computer-moves-calculated")
  if (moves_calculated) {
    moves_calculated.innerText = str(position_count)
  }
...
function computer_move() {
  ...
  const computer_moves_time = document.getElementById("computer-moves-time")
  if (computer_moves_time) {
    computer_moves_time.innerText = str((d2 - d)/1000) + "s"
  }
...
function increase_difficulty() {
  ...
  if (difficulty > 5) difficulty = 1;
   ...
   document.getElementById("chess-difficulty").innerText = "Difficulty: " + difficulty + "/5"
}
...
function set_difficulty_one() {
  ...
  document.getElementById("diff-three").style.backgroundColor = '#b1a58d';
  document.getElementById("diff-four").style.backgroundColor = '#b1a58d';
  document.getElementById("diff-five").style.backgroundColor = '#b1a58d';
}
...
function toggle_cheating() {
  if (crooked == false) {
    ...
    document.getElementById("cheating-btn").style.backgroundColor = '#b1a58d';
    crooked = false;
  }
